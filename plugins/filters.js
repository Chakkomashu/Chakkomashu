...
const array = ['Hi','power','sad','anthas','failed','alla','chunk','marichu','myre','think','cheyalle','mention','mama','set','eda','umma','police','aysheri','vannu','love','manasilla','uyir','oombi','Mm','important','sed','chathu','girl','poweresh','ooo','bye','fuck','pedicho','kunna','number','ok','Arjun','Machane','alavalathy potta manda poyille','mm','arumille arulle','lub u','Tnx','Chakkare i lub u muthe','urangikko pokko sleep bye','Dark','romance da vaa arum ille','arada','sad','appo sheri','Njan','engana','Hi','ara','enna eduka','pwoli','chiri','vibe','shut','saved','mood','shaad','pidi']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
